 ...
 */
class PopularGridAdapter: RecyclerView.Adapter<PopularGridAdapter.ViewHolder> {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): ViewHolder {
        var view = LayoutInflater.from(act).inflate(R.layout.grid_item_row, parent, false)
